  ...
  return (
    <section className="container-page py-16">
      <div className="max-w-3xl mb-10">
        ...
        <p className="mt-3 text-ink-600 leading-relaxed">Mark your calendar — here&apos;s what&apos;s coming up next at HTDSS.</p>
      </div>
      ...
      <article className="grid lg:grid-cols-2 rounded-2xl border border-ink-100 bg-white overflow-hidden shadow-sm">
        <div className="bg-ink-50 flex items-center justify-center p-4">
          <img
        ...
        <div className="p-8 lg:p-10 flex flex-col justify-center">
          ...
          <h3 className="mt-2 font-display font-bold text-2xl lg:text-3xl text-ink-900">
          ...
          <Link href="/11th-conference" className="btn-primary mt-7 w-fit">View details</Link>
        </div>
      </article>
    </section>
  );
