      ...
      <section className="container-page py-10 sm:py-14 lg:py-16">
        <div className="flex flex-wrap items-end justify-between gap-4 sm:gap-6 mb-6 sm:mb-8">
          <div className="max-w-2xl">
            <h2 className="font-display font-bold text-2xl sm:text-3xl text-ink-900">Annual conferences</h2>
            <p className="mt-3 sm:mt-4 text-sm sm:text-base text-ink-600 leading-relaxed">From the very first scientific conference in 2018 at ITC Fortune to the most recent — a record of every HTDSS national conference.</p>
          </div>
